...
def main():
    path = "diabetic_data/DataSet/dataset_diabetes/diabetic_data.csv"
    sample = 15000
    ...
    data.dimension_reduction(method='PCA', n_components=0.85, visualize=False,
    ...
    # km_st.write_results('K_Means_Statistical_test_results.txt')
    # fcm_st.write_results('FCM_Statistical_test_results.txt')
    # gmm_st.write_results('GMM_Statistical_test_results.txt')
    # hir_st.write_results('Hierarchical_Statistical_test_results.txt')
    # spec_st.write_results('Spectral_Statistical_test_results.txt')
    ...
    km_n_clusters = [2, 3, 15]  # 15 came from the wss elbow method.
    fcm_n_clusters = [2, 3]
    gmm_n_clusters = [2]
    hir_n_clusters = [2]
    spec_n_clusters = [2]
